...
function randomSpikeTarget() {
  return Math.floor(Math.random() * (300 - 100 + 1)) + 100; // Generate random target between 100 and 300 VUs
}
export let options = {
  stages: [
    // Random spike scenario
    { duration: '5m', target: 50 },  // Ramp up to 50 VUs and stay for 5 minutes
    { duration: '10m', target: randomSpikeTarget() }, // Random spike to a target between 100 and 200 VUs and stay for 10 minutes
    { duration: '5m', target: 50 },   // Ramp down to 50 VUs over 5 minutes

    // Constant spike scenario
    { duration: '5m', target: 50 },  // Ramp up to 50 VUs and stay for 5 minutes
